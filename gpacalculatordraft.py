...
print ('Credits of Fat is' ,credit_class_one)
...
print ('Credits of Writing 121 is' ,credit_class_two)
...
print ('Credits of CAD 1 is' ,credit_class_three)
...
print ('Credits of AP Computer Science is' ,credit_class_four)
